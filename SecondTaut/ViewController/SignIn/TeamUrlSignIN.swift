...
class TeamUrlSignIN: UIViewController,UITextFieldDelegate,ApiResponceDelegateMB,NVActivityIndicatorViewable {
    ...
    @IBAction func btnFindYOurTeam(_ sender: Any) {
        let Instace = self.storyboard?.instantiateViewController(withIdentifier: "EmailFindYourTeam") as! EmailFindYourTeam
    ...
    func ApiResponceSuccess(Success: NSDictionary) {
        ...
        self.stopAnimating()
        let Instace = self.storyboard?.instantiateViewController(withIdentifier: "EmailSignIn") as! EmailSignIn
